...
namespace RezkaFree
{
    public class RezkaFreeInvoke
    {
        static readonly Serilog.ILogger Log = Serilog.Log.ForContext<RezkaFreeInvoke>();

        #region RezkaFreeInvoke
        RezkaFreeSettings init;
        ...
        public RezkaFreeInvoke(string host, string route, RezkaFreeSettings init, bool safety, List<HeadersModel> defaultHeaders, HttpHydra httpHydra, Func<string, string> onstreamfile, Action requesterror = null)
        {
        ...
        public static List<HeadersModel> StreamProxyHeaders(RezkaFreeSettings init) => HeadersModel.Init(init.headers,
            ("accept", "*/*"),
            ("cache-control", "no-cache"),
            ("dnt", "1"),
            ("origin", init.host),
